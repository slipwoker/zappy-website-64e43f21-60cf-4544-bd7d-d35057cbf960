    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "אהיה תכנון אורבני וניהול פרויקטים בע\"מ משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            const response = await fetch('https://api.zappy5.com/api/email/contact-form', {
                ...
                body: JSON.stringify({
                    websiteId: '64e43f21-60cf-4544-bd7d-d35057cbf960',
                    name: data.name || '',
                    email: data.email || '',
